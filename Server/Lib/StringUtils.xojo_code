#tag Module
 Attributes ( "@Version" = "1.0.1", "@Copyright" = "watermann-it.de", "@Guid" = "30834442-3ED1-4F86-8C2C-B6A2B7E22382", "@Author" = "Stefan Watermann", "@Description" = "Extensions to string" ) Protected Module StringUtils
	#tag Method, Flags = &h0
