#tag Class
 Attributes ( packVersion = "1.0", packCopyright = "(c) 2022 watermann-it.de", packGuid = "7391BC4F-5E17-4EED-A7FC-7D000EF67BA5", packAuthor = "Stefan Watermann", packDescription = "Base-class used for model-classes to convert to and from JSON.", packDepends = "-" ) Protected Class JsonModelBase
	#tag Method, Flags = &h0
